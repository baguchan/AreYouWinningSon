package baguchan.ayws.client.animation;// Save this class in your mod and generate all required imports
...
public class VillagerAnimation {
	public static final AnimationDefinition dance = AnimationDefinition.Builder.withLength(2.5F).looping()
		...
		.addAnimation("right_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.5F, KeyframeAnimations.degreeVec(-33.3441F, 11.3134F, 16.6018F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.875F, KeyframeAnimations.degreeVec(-33.34F, 11.31F, 16.6F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.25F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		...
		.addAnimation("left_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			new Keyframe(1.25F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.75F, KeyframeAnimations.degreeVec(-31.2822F, -9.298F, -14.8915F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(2.125F, KeyframeAnimations.degreeVec(-31.2822F, -9.298F, -14.8915F), AnimationChannel.Interpolations.LINEAR),
	...
	public static final AnimationDefinition dance_rotate = AnimationDefinition.Builder.withLength(2.5F).looping()
